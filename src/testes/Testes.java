...
public class Testes {
    ...
    public void deveListarNomeDoVoluntario() {
        LocalDateTime HorarioEvento = LocalDateTime.of(2026, 8, 8, 10, 0);
        ...
        Plantio plantioNovo1 = sistema.getPlantios().getFirst();

        sistema.inscreverVoluntario("mateusferreira@unifacisa.com", plantioNovo1.getIdAcao());

        assertEquals("[Mateus, Ana]", sistema.listarVoluntarios());
    }
